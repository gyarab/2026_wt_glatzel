...
![Fotka Larryho Teslera z Wikipedie](Larry_Tesler_Smiles_at_Whisper.jpeg)
...
* **Larry Tesler**
  * **Co dokázal:**
    * Vyvinul koncept funkcí **Cut, Copy, and Paste** (vyjmout, kopírovat, vložit)
    * Vytvořil koncept **nemodálního softwaru** (software bez nutnosti přepínat režimy)
    * Spolupracoval na projektech **Smalltalk** a **Gypsy** (první GUI textový editor)
    * V pracoval v Apple na projektech Lisa, Newton a jazyce **Object Pascal**
  * **O něm:**
    * **Narození:** 24. dubna 1945, The Bronx, New York City, U.S.
    * **Úmrtí:** 16. února 2020

---

## Zdroje
* [Zdroj textu (Wikipedia)](https://en.wikipedia.org/wiki/Larry_Tesler) – k datu 23. 9. 2026
* [Zdroj fotografie (Wikipedia)](https://en.wikipedia.org/wiki/Larry_Tesler#/media/File:Larry_Tesler_Smiles_at_Whisper.jpeg) – k datu 23. 9. 2026
